...
export class DataService {
  ...
  getData(): Observable<User[]> {
    const url = 'https://65aa1db2081bd82e1d961d5d.mockapi.io/to-do/crud';
  ...
  postDataStudent( name: string, avatar: string, email:string, subject1:number,subject2:number,subject3:number): Observable<User[]> {
    ...
    const apiUrl = 'https://65aa1db2081bd82e1d961d5d.mockapi.io/to-do/crud';
  ...
  getUserData(id: number): Observable<User[]> {
    ...
    const url = `https://65aa1db2081bd82e1d961d5d.mockapi.io/to-do/crud${id}`;
